    ...
    <div class="wrapper">
      <div class="topnav">
              ...
              <nav>
                  <ul>
                      <li>
                          <a class="set_jazyk" style="background-image:url('https://flagpedia.net/data/flags/w580/jp.png');background-size:cover;background-position:center" href="comedy.php?jazyk=jp"></a>
                      </li>
                      <li>
                          <a class="set_jazyk" style="background-image:url('https://cdn.webshopapp.com/shops/94414/files/54954514/the-united-kingdom-flag-vector-free-download.jpg');background-size:cover;background-position:center" href="comedy.php?jazyk=en"></a>
                      </li>
                      <li>
                          <a class="set_jazyk" style="background-image:url('https://cdn.countryflags.com/thumbs/china/flag-800.png');background-size:cover;background-position:center" href="podstranky/comedy.php?jazyk=ch"></a>
                      </li>
                      <li>
                          <a class="set_jazyk" style="background-image:url('https://upload.wikimedia.org/wikipedia/en/archive/f/f3/20120812153730%21Flag_of_Russia.svg');background-size:cover;background-position:center" href="comedy.php?jazyk=ru"></a>
                      </li>
                      <li>
                          <a class="set_jazyk" style="background-image:url('https://upload.wikimedia.org/wikipedia/en/thumb/b/ba/Flag_of_Germany.svg/1280px-Flag_of_Germany.svg.png');background-size:cover;background-position:center" href="comedy.php?jazyk=ge"></a>
                      </li>
                  </ul>
              </nav>
        ...
        <span class="close">&times;</span>
              ...
              <div id="option1-yes">
                ...
                <div class="tab">Please enter the URL link:
                  <p><input type="text" name="url" placeholder="URL link..."></p>
                </div>
                ...
                <div class="tab">Additional comment:
                  <p><input name="popis" placeholder="Write here..."></p>
              ...
              <div id="option1-no">Let's go to the mall! There's a mall 15 miles away from you.</div>
        </div>
      </div>
    </div>
  </div>
    ...
    <div class="flex-container">   
        ...
        if($result = mysqli_query($db, $sql)){
          ...
          while($row = mysqli_fetch_array($result)){
               echo '<a class="obal_obrazku" href="http://youtube.com/watch?v=' . $row[video_odkaz] . '">
               <img src="http://img.youtube.com/vi/' . $row[video_odkaz] . '/mqdefault.jpg"/>
               <div class="img_description_layer">
                <p class="img_description">Popis videa!</p>
               </div>
               </a>';
        }
        $pocet--;
