    ...
    <div class="wrapper">
      <div class="topnav">
              ...
              <nav>
                  <ul>
                      <li>
                          <a class="set_jazyk" style="background-image:url('https://flagpedia.net/data/flags/w580/jp.png');background-size:cover;background-position:center" href="../podstranky/vlog?jazyk=jp"></a>
                      </li>
                      <li>
                          <a class="set_jazyk" style="background-image:url('https://cdn.webshopapp.com/shops/94414/files/54954514/the-united-kingdom-flag-vector-free-download.jpg');background-size:cover;background-position:center" href="../podstranky/vlog?jazyk=en"></a>
                      </li>
                      <li>
                          <a class="set_jazyk" style="background-image:url('https://cdn.countryflags.com/thumbs/china/flag-800.png');background-size:cover;background-position:center" href="../podstranky/vlog?jazyk=ch"></a>
                      </li>
                      <li>
                          <a class="set_jazyk" style="background-image:url('https://upload.wikimedia.org/wikipedia/en/archive/f/f3/20120812153730%21Flag_of_Russia.svg');background-size:cover;background-position:center" href="../podstranky/vlog?jazyk=ru"></a>
                      </li>
                      <li>
                          <a class="set_jazyk" style="background-image:url('https://upload.wikimedia.org/wikipedia/en/thumb/b/ba/Flag_of_Germany.svg/1280px-Flag_of_Germany.svg.png');background-size:cover;background-position:center" href="../podstranky/vlog?jazyk=ge"></a>
                      </li>
                  </ul>
              </nav>
